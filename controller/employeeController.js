...
export const update = async(req, res) => {
        try {
                ...
                const updateEmpoyee = await Employee.findByIdAndUpdate(id, req.body, { new : true})
                res.status(201).json(updateEmpoyee)
...
/* export const deleteEmployee = async(req, res) => {
        try {
                ...
                const updateEmpoyee = await Employee.findByIdAndDelete(id)
